...
const EVENTOS_BODA = [
  ...
  {
    nombre: "Reunión Cocktail", emoji: "🍸",
    detalle: "Reunión informal del día después",
    categoria: "Reunión Cocktail",
    color: "dorado",
    icon: Coffee,
...
const QUE_HACER = [
  ...
  },
  {
    ...
    lugares: [
      ...
      {
        nombre: "Lucha Libre — Martes de Glamour", emoji: "🤼",
...
const GASTRONOMIA = [
  {
    ...
    icon: ChefHat,
    lugares: [
      { nombre: "Karne Garibaldi", emoji: "🍲", favorito: true, sucursal: "Sucursal Mariano Otero o Garibaldi (Santa Tere)", direccion: "Karne Garibaldi, Av. Mariano Otero 3019, Zapopan, Jalisco", tipo: "Carne en su jugo", precio: "$$", porQue: "Guinness World Record al servicio más rápido; un clásico absoluto de Guadalajara.", idealPara: "Comida", nota: "Cadena con varias sucursales — recomendamos la de Mariano Otero o la de Garibaldi, en Santa Tere.", x: 58, y: 43 },
      { nombre: "Birriería El Chololo", emoji: "🐐", favorito: true, direccion: "Birriería El Chololo, Carretera Guadalajara-Chapala Km 17, Guadalajara, Jalisco", tipo: "Birria tapatía", precio: "$$$", porQue: "Lugar emblemático de Guadalajara — han comido ahí celebridades e incluso un Papa. Imperdible.", idealPara: "Desayuno o comida", x: 35, y: 33 },
      { nombre: "Birriería Las 9 Esquinas", emoji: "🍽️", favorito: true, direccion: "Birriería Las 9 Esquinas, Plaza de las Nueve Esquinas, Guadalajara, Jalisco", tipo: "Birria tradicional del Centro", precio: "$$", porQue: "Ubicada en un barrio con mucho carácter histórico, buena relación calidad-ambiente.", idealPara: "Desayuno o comida", x: 60, y: 48 },
      { nombre: "La Chata", emoji: "🍜", favorito: true, direccion: "La Chata de Guadalajara, Av. Terranova 405, Providencia, Guadalajara, Jalisco", tipo: "Cocina tapatía", precio: "$$", porQue: "Pozole blanco imperdible; recomendamos la sucursal Terranova para evitar las filas del Centro.", idealPara: "Comida", x: 56, y: 44 },
      { nombre: "Santo Coyote", emoji: "🌵", tipo: "Restaurante mexicano — buffet de desayuno, carta de comida y cena", precio: "$$$", porQue: "Excelente calidad, aunque es de los más caros; agregamos ambas sucursales en la búsqueda.", idealPara: "Cena especial", x: 44, y: 37 },
  ...
  },
  {
    ...
    icon: Sandwich,
    lugares: [
      { nombre: "Tortas Toño", emoji: "🥪", favorito: true, tipo: "Tortas ahogadas", precio: "$", porQue: "Nació en Providencia en 1990 y es la marca líder de torta ahogada en la ciudad.", idealPara: "Antojo o comida rápida", nota: "Tiene muchas sucursales por toda la ciudad — este link busca todas las opciones cercanas.", x: 47, y: 32 },
      ...
      { nombre: "Lonches", emoji: "🥪", tipo: "Lonches (versión más pequeña y sencilla de la torta, típica de puestos y loncherías tapatías)", precio: "$", porQue: "Un antojo rápido y muy tapatío, más ligero que una torta completa.", idealPara: "Antojo o desayuno rápido", nota: "Algunos ejemplos populares: Karlos, El Pesebre y Gemma.", x: 46, y: 35 },
    ],
  },
  {
    categoria: "Tacos",
    ...
    icon: Soup,
    lugares: [
      { nombre: "Tacos El Ranchero", emoji: "🌮", tipo: "Barbacoa tradicional", precio: "$", porQue: "Cadena con muchas sucursales por la ciudad, especializada en barbacoa tradicional.", idealPara: "Antojo / desayuno", x: 44, y: 42 },
      { nombre: "Tacos Juan", emoji: "🌮", favorito: true, direccion: "Tacos Juan, Santa Teresita, Guadalajara, Jalisco", tipo: "Barbacoa tradicional", precio: "$", porQue: "Favorito local de barrio, en Santa Tere.", idealPara: "Desayuno", x: 45, y: 40 },
      { nombre: "Tacos Don Miguelón", emoji: "🌮", tipo: "Tacos de carne asada", precio: "$", porQue: "Recomendado para cena, pero solo si ya están por la zona.", idealPara: "Cena (si están por la zona)", x: 46, y: 38 },
      { nombre: "Los Alteños", emoji: "🌮", favorito: true, direccion: "Los Alteños, Av. Cubilete, Chapalita Sur, Zapopan, Jalisco", tipo: "Taquería tradicional nocturna", precio: "$", porQue: "Muy recomendada; también tienen agua de frutas. Está en zona caminable y hay mucha gente por las noches — buena señal.", idealPara: "Antojo / cena", x: 50, y: 42 },
      { nombre: "Super Taco Tomás", emoji: "🌮", tipo: "Tacos de lengua", precio: "$", porQue: "Un poco caros pero imperdibles; están cerca de la zona de Minerva/Americana.", idealPara: "Antojo", x: 44, y: 44 },
      { nombre: "Tacos Guadalupe (Tacos Sinaloa)", emoji: "🍤", direccion: "Tacos Guadalupe estilo Sinaloa, Av. Guadalupe, Arcos de Guadalupe, Zapopan, Jalisco", tipo: "Tacos estilo Sinaloa", precio: "$", porQue: "Estilo norteño de taco, buena variante dentro de la escena tapatía. Link a la sucursal mejor calificada.", idealPara: "Antojo / cena", x: 48, y: 45 },
    ],
  },
  {
    categoria: "Mariscos",
    ...
    icon: Fish,
    lugares: [
      { nombre: "El Dorado (San Agustín)", emoji: "🦐", favorito: true, direccion: "Mariscos El Dorado, Av. López Mateos Sur, San Agustín, Tlajomulco de Zúñiga, Jalisco", tipo: "Mariscos", precio: "$$", porQue: "Recomendado el camarón zarandeado y los tacos de frijol; está cerca de Punto Sur.", idealPara: "Comida", x: 78, y: 68 },
      ...
      { nombre: "Campomar", emoji: "🦞", favorito: true, tipo: "Mariscos — ambiente de restaurante", precio: "$$", porQue: "Muy popular; tienen sucursal en Punto Sur.", idealPara: "Comida", x: 40, y: 42 },
      ...
      { nombre: "La Paceña", emoji: "🐟", direccion: "La Paceña, Ajijic, Jalisco", tipo: "Mariscos", precio: "$$", porQue: "Muy recomendado en Ajijic, buena parada si están explorando la zona de Chapala.", idealPara: "Comida", x: 18, y: 96 },
    ],
  },
  {
    ...
    lugares: [
      ...
      { nombre: "Coco Café", emoji: "☕", favorito: true, direccion: "Coco Café, Ramal de La Tijera 701, La Tijera, Tlajomulco de Zúñiga, Jalisco", tipo: "Café de especialidad", precio: "$$", porQue: "Excelente desayuno; no es el mejor lugar para trabajar, pero está cerca de Punto Sur.", idealPara: "Desayuno / café", x: 42, y: 38 },
      { nombre: "PalReal", emoji: "☕", favorito: true, tipo: "Café de especialidad", precio: "$$", porQue: "Muy popular entre locales en Colonia Americana; no se pierdan el Toast de Pancita.", idealPara: "Desayuno / café", x: 43, y: 39 },
      ...
      { nombre: "Cristina", emoji: "☕", direccion: "Restaurante Cristina, Av. Empresarios, Puerta de Hierro, Zapopan, Jalisco", tipo: "Café de especialidad", precio: "$$", porQue: "Ambiente agradable, buena opción de paso por la mañana.", idealPara: "Desayuno / café", x: 44, y: 34 },
      { nombre: "Alba Cocina Diversa", emoji: "🍽️", favorito: true, tipo: "Cocina de autor", precio: "$$$", porQue: "Propuesta contemporánea con producto local, muy bien valorada — no se pierdan sus conchas.", idealPara: "Desayuno / cena especial", x: 44, y: 34 },
    ],
  },
  {
    ...
    icon: PartyPopper,
    lugares: [
      { nombre: "Casa Bariachi", emoji: "🎉", favorito: true, direccion: "Casa Bariachi, Av. Ignacio L. Vallarta 2221, Guadalajara, Jalisco", tipo: "Mariachi en vivo + cocina mexicana", precio: "$$", porQue: "Ambiente festivo con mariachi en vivo, ideal para grupos grandes.", idealPara: "Cena en grupo", x: 42, y: 37 },
      { nombre: "La Estancia (Cenaduría Tradicional)", emoji: "🌃", direccion: "Menudería Cenaduría La Estancia, Av. Terranova, Prados Providencia, Guadalajara, Jalisco", tipo: "Antojitos nocturnos", precio: "$", porQue: "Vivir la tradición tapatía de la 'cenaduría': pozole, enchiladas, sopes por la noche. Sucursales en Providencia y Guadalupe.", idealPara: "Cena informal", x: 58, y: 46 },
      { nombre: "Los Sencillitos", emoji: "🥩", tipo: "Cortes argentinos", precio: "$$", porQue: "Ambiente relajado; bueno, bonito y barato, con excelente comida.", idealPara: "Comida o cena", x: 52, y: 40 },
      { nombre: "La Casa de los Platos", emoji: "🍽️", tipo: "Restaurante mexicano", precio: "$$$", porQue: "Ambiente casero para una comida completa.", idealPara: "Comida", x: 44, y: 35 },
    ],
  },
];
...
const INFO_UTIL = [
  ...
  { icon: CloudSun, color: "verde", titulo: "Clima", texto: "Guadalajara tiene clima templado todo el año. En temporada de lluvias (junio-octubre) hay chubascos por las tardes; en temporada seca los días son soleados y las noches frescas. Lleven ropa en capas." },
