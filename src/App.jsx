...
const EVENTOS_BODA = [
  {
    nombre: "Capilla El Filamentario", emoji: "⛪",
    ...
    nota: "Confirmaremos horario más adelante.",
  },
  {
    nombre: "La Dovena", emoji: "🥂",
    detalle: "Recepción",
    categoria: "Recepción",
    color: "rosa",
    icon: PartyPopper,
  ...
  {
    nombre: "Torna boda", emoji: "☕",
    detalle: "Reunión informal del día después",
    categoria: "Torna boda",
    color: "dorado",
    icon: Coffee,
    fecha: "Domingo 31 de enero de 2027",
    zona: "Ubicación por confirmar",
    direccion: null,
    nota: "Lo más probable es que sea también en la zona de los eventos de la boda (Tlaquepaque). En cuanto la confirmemos, la actualizamos aquí.",
  },
];
...
const ZONAS_HOSPEDAJE = [
  {
    ...
    pros: ["Cercanía directa a los eventos", "Zona nueva con buena oferta de hospedaje", "Fácil acceso por Periférico"],
  ...
  {
    nombre: "Minerva / Providencia / Americana",
    ...
    contras: ["Un poco más de trayecto hacia los eventos", "Tráfico en horas pico"],
...
const HOSPEDAJE_TRAFICO = "El sábado de la boda, Av. López Mateos rumbo al sur suele saturarse bastante. Si se hospedan sobre esa ruta, consideren salir con tiempo extra.";
...
const QUE_HACER = [
  {
    ...
    lugares: [
      {
        nombre: "Centro Histórico de Guadalajara", emoji: "🏛️",
        descripcion: "El casco antiguo de la ciudad: catedral, plazas y edificios coloniales conectados a pie.",
        ...
        foto: "https://commons.wikimedia.org/wiki/Special:FilePath/Catedral_de_Guadalajara,_Jalisco,_Mexico.JPG?width=500",
        x: 58, y: 44,
      },
      {
        nombre: "Hospicio Cabañas", emoji: "🎨",
        ...
        foto: "https://commons.wikimedia.org/wiki/Special:FilePath/Hospicio_Caba%C3%B1as,_Guadalajara,_Jal.jpg?width=500",
        x: 60, y: 43,
      },
      {
        ...
        foto: "https://commons.wikimedia.org/wiki/Special:FilePath/Templo_Expiatorio_del_Sant%C3%ADsimo_Sacramento_de_Guadalajara_8.jpg?width=500",
        x: 50, y: 40,
      },
      {
        nombre: "Paseo Alcalde", emoji: "🚶",
        descripcion: "Corredor peatonal y ciclista que conecta el Centro con Zapopan.",
        porQue: "Buena forma de moverse a pie o en bici entre puntos clave.",
        tiempo: "Flexible", costo: "Gratis", psur: "35-45 min", min: "15-20 min",
        tip: "Ideal para una caminata relajada al atardecer.",
        x: 54, y: 38,
      },
      {
        nombre: "Plaza de los Mariachis", emoji: "🎻",
      ...
      },
      {
        ...
        foto: "https://commons.wikimedia.org/wiki/Special:FilePath/Teatro_Degollado_Guadalajara.JPG?width=500",
        x: 57, y: 45,
      },
      {
        nombre: "MUSA (Museo de las Artes)", emoji: "🖼️",
      ...
      {
        nombre: "JAPI (Jalisco Paseo Interactivo)", emoji: "🕹️",
  ...
  },
  {
    ...
    lugares: [
      {
        nombre: "Colonia Americana", emoji: "🏘️",
      ...
      {
        nombre: "Avenida Chapultepec", emoji: "🌳",
        descripcion: "Bulevar arbolado con camellón central, terrazas y vida nocturna.",
      ...
      {
        nombre: "Centro de Zapopan", emoji: "🙏",
        ...
        tip: "La Basílica es sitio de peregrinación importante, respeten el ambiente religioso al visitar.",
        x: 27, y: 22,
      },
      {
        nombre: "Centro de San Pedro Tlaquepaque", emoji: "🏺",
        ...
        tip: "El Parián es la plaza de cantinas con mariachi en vivo, muy buena para cenar en grupo.",
        foto: "https://commons.wikimedia.org/wiki/Special:FilePath/El_Mariachi_en_el_Par%C3%ADan_de_Tlaquepaque_Jalisco.jpg?width=500",
        x: 73, y: 63,
      },
      {
        nombre: "Centro Artesanal de Tonalá", emoji: "🧵",
  ...
  },
  {
    ...
    lugares: [
      {
        nombre: "Andares", emoji: "🛍️",
        descripcion: "Centro comercial de lujo, el más exclusivo de la ciudad.",
        ...
        tip: "Está muy cerca de Punto Sur, buena opción si se hospedan ahí.",
        x: 20, y: 15,
      },
      {
        nombre: "Midtown Jalisco", emoji: "🏙️",
        ...
        tip: "Buena opción de paso si están cerca de Punto Sur.",
        x: 46, y: 64,
      },
      {
        nombre: "La Perla", emoji: "🛒",
  ...
  },
  {
    ...
    lugares: [
      {
        nombre: "Bosque Los Colomos", emoji: "🌲",
      ...
      {
        nombre: "Mirador Barranca de Huentitán", emoji: "🏞️",
  ...
  },
  {
    ...
    lugares: [
      {
        nombre: "Estadio Akron", emoji: "⚽",
        descripcion: "Casa de las Chivas, uno de los estadios más modernos de México.",
        ...
        tip: "Revisen el calendario de Liga MX antes de su viaje, solo aplica si hay partido.",
        x: 28, y: 50,
      },
      {
        nombre: "Estadio Jalisco", emoji: "🏟️",
      ...
      {
        nombre: "Zoológico Guadalajara", emoji: "🦁",
  ...
  },
  {
    ...
    esEdge: true,
    lugares: [
      { nombre: "Centro de Tequila", emoji: "🥃", descripcion: "Pueblo mágico cuna del tequila, rodeado de agavales Patrimonio de la Humanidad.", porQue: "La excursión imperdible: destilerías, historia y paisaje de agave azul.", tiempo: "Día completo", costo: "Tour desde ~$800-1,500 MXN por persona", psur: "1h 15min - 1h 30min", min: "1h - 1h 15min", tip: "Mejor ir en tour organizado (incluye transporte y catas) que manejando.", edgeSide: "left", edgeY: 30 },
      { nombre: "Cantaritos El Güero (Amatitán)", emoji: "🍹", descripcion: "Parada clásica en el trayecto a Tequila, famosa por su cantarito tradicional.", porQue: "Una parada icónica que complementa perfecto la ruta del tequila.", tiempo: "45 min - 1 hora", costo: "~$100-150 MXN por cantarito", psur: "1h - 1h 15min", min: "50 min - 1h 10min", tip: "Va de camino a Tequila, inclúyanlo en el mismo día.", edgeSide: "left", edgeY: 45 },
      { nombre: "Lago de Chapala", emoji: "🚤", descripcion: "El lago más grande de México, con pueblos ribereños tranquilos.", porQue: "Paisaje distinto: lago, malecón y ambiente relajado fuera de la ciudad.", tiempo: "Medio día - día completo", costo: "Gratis el paseo (comidas aparte)", psur: "45-55 min", min: "1h - 1h 10min", tip: "Se puede combinar con Ajijic el mismo día.", edgeSide: "bottom", edgeY: 65 },
      { nombre: "Ajijic", emoji: "🎨", descripcion: "Pueblo con encanto a orillas de Chapala, calles empedradas y galerías de arte.", porQue: "Uno de los pueblos con más carácter cerca de Guadalajara.", tiempo: "3-4 horas", costo: "Gratis caminar", psur: "50 min - 1h", min: "1h - 1h 15min", tip: "Combínenlo con Chapala, están a 10-15 minutos uno del otro.", edgeSide: "bottom", edgeY: 80 },
    ],
  },
  {
    categoria: "Escapadas",
    ...
    esEdge: true,
    lugares: [
      { nombre: "Tapalpa", emoji: "🌲", descripcion: "Pueblo mágico de montaña, con clima fresco y arquitectura de teja y adobe.", porQue: "Cambio de paisaje total: bosques de pino y ambiente de pueblo serrano.", tiempo: "1-2 días (o día completo apretado)", costo: "Variable según hospedaje/actividades", psur: "2h - 2h 15min", min: "2h 15min - 2h 30min", tip: "Si solo tienen un día, salgan muy temprano; idealmente se disfruta quedándose una noche.", edgeSide: "bottom", edgeY: 40 },
      { nombre: "Mazamitla", emoji: "🏔️", descripcion: "Pueblo mágico de montaña con estilo alpino, cabañas y clima frío.", porQue: "Ambiente de 'pueblo de nieve' sin nieve, muy fotogénico.", tiempo: "1-2 días (o día completo apretado)", costo: "Variable según hospedaje/actividades", psur: "2h - 2h 20min", min: "2h 15min - 2h 35min", tip: "Lleven ropa abrigadora, las noches son frías incluso en temporadas templadas.", edgeSide: "bottom", edgeY: 52 },
      { nombre: "San Miguel el Alto", emoji: "🌾", descripcion: "Pueblo de Los Altos de Jalisco, con arquitectura característica y ambiente ranchero.", porQue: "Una cara distinta de Jalisco, menos turística y muy auténtica.", tiempo: "Día completo", costo: "Gratis caminar", psur: "1h 45min - 2h", min: "1h 40min - 1h 55min", tip: "Buena opción si ya conocen Tequila y Tlaquepaque y quieren algo menos común.", edgeSide: "right", edgeY: 35 },
    ],
  },
];
...
const GASTRONOMIA = [
  {
    ...
    icon: ChefHat,
    lugares: [
      { nombre: "Karne Garibaldi", emoji: "🍲", sucursal: "Sucursal Santa Tere", direccion: "Calle Garibaldi 1306, Santa Teresita, Guadalajara", tipo: "Carne en su jugo", precio: "$$", porQue: "Guinness World Record al servicio más rápido; un clásico absoluto de Guadalajara.", idealPara: "Comida", nota: "Cadena con varias sucursales — esta es la original, cerca del Centro Histórico. También hay sucursal en Plaza Galerías, junto a Andares/Zapopan.", x: 58, y: 43 },
      { nombre: "El Chololo", emoji: "🐐", tipo: "Cocina tapatía / birria", precio: "$$", porQue: "Institución de varias generaciones, ambiente familiar tradicional.", idealPara: "Comida", x: 35, y: 33 },
      { nombre: "Las 9 Esquinas", emoji: "🍽️", tipo: "Cocina tapatía", precio: "$$", porQue: "Ubicado en un barrio con mucho carácter histórico, buena relación calidad-ambiente.", idealPara: "Comida o cena", x: 60, y: 48 },
      { nombre: "La Chata", emoji: "🍜", tipo: "Cocina tapatía", precio: "$$", porQue: "Décadas de tradición sirviendo platillos típicos jaliscienses.", idealPara: "Comida", x: 56, y: 44 },
      { nombre: "Santo Coyote", emoji: "🌵", tipo: "Cocina mexicana / ambiente", precio: "$$$", porQue: "Experiencia completa: decoración espectacular además de buena comida.", idealPara: "Cena especial", x: 44, y: 37 },
      { nombre: "Casa Luna", emoji: "🌙", tipo: "Cocina mexicana contemporánea", precio: "$$$", porQue: "Buena opción para una comida más elegante sin salir de lo tradicional.", idealPara: "Comida o cena", x: 42, y: 36 },
    ],
  },
  {
    categoria: "Tortas",
    ...
    icon: Sandwich,
    lugares: [
      { nombre: "Tortas Toño", emoji: "🥪", sucursal: "Sucursal Providencia", direccion: "Tierra de Fuego 3160, Col. Providencia, Guadalajara", tipo: "Tortas ahogadas", precio: "$", porQue: "Nació en Providencia en 1990 y es la marca líder de torta ahogada en la ciudad.", idealPara: "Antojo o comida rápida", nota: "Cadena con varias sucursales — esta es la más cercana a la zona de Minerva/Providencia.", x: 47, y: 32 },
      { nombre: "Tortas Alex Co", emoji: "🥪", tipo: "Tortas", precio: "$", porQue: "Otra opción muy recomendada por locales para una torta contundente.", idealPara: "Antojo o comida rápida", x: 48, y: 34 },
    ],
  },
  {
    categoria: "Tacos",
    ...
    icon: Soup,
    lugares: [
      { nombre: "Tacos Juan", emoji: "🌮", tipo: "Tacos", precio: "$", porQue: "Favorito local de barrio.", idealPara: "Antojo", x: 45, y: 40 },
      { nombre: "Tacos Don Miguelón", emoji: "🌮", tipo: "Tacos de carne asada", precio: "$", porQue: "Muy recomendado para taco nocturno de carne asada.", idealPara: "Cena / antojo", x: 46, y: 38 },
      { nombre: "Los Alteños", emoji: "🌮", tipo: "Tacos al pastor / carnitas", precio: "$", porQue: "Clásico tapatío de trompo.", idealPara: "Antojo", x: 50, y: 42 },
      { nombre: "Super Taco Tomás", emoji: "🌮", tipo: "Tacos", precio: "$", porQue: "Otro punto de referencia local para taco callejero de calidad.", idealPara: "Antojo", x: 44, y: 44 },
      { nombre: "Los Sencillitos", emoji: "🌮", tipo: "Tacos", precio: "$", porQue: "Muy recomendado por su sazón, sencillo y sabroso.", idealPara: "Antojo", x: 52, y: 40 },
      { nombre: "Tacos Guadalupe (Tacos Sinaloa)", emoji: "🍤", tipo: "Tacos estilo Sinaloa", precio: "$", porQue: "Estilo norteño de taco, buena variante dentro de la escena tapatía.", idealPara: "Antojo / cena", x: 48, y: 45 },
      { nombre: "Tacos Los Sahuaros", emoji: "🌮", tipo: "Tacos", precio: "$", porQue: "Otro favorito local para completar el recorrido taquero.", idealPara: "Antojo", x: 43, y: 42 },
    ],
  },
  {
    categoria: "Mariscos",
    ...
    icon: Fish,
    lugares: [
      { nombre: "El Dorado (Santa Anita)", emoji: "🦐", tipo: "Mariscos", precio: "$$", porQue: "Punto de referencia para mariscos frescos en la zona metropolitana.", idealPara: "Comida", x: 78, y: 68 },
      { nombre: "Taco Fish La Paz", emoji: "🐟", tipo: "Tacos de mariscos estilo Baja", precio: "$", porQue: "Muy popular por sus tacos de pescado y camarón estilo Baja California.", idealPara: "Comida / antojo", x: 44, y: 39 },
    ],
  },
  {
    ...
    icon: Coffee,
    lugares: [
      { nombre: "Terrible Juan Café", emoji: "☕", tipo: "Café de especialidad", precio: "$$", porQue: "Buen café en ambiente relajado de Colonia Americana.", idealPara: "Desayuno", x: 43, y: 36 },
      { nombre: "La Casa de los Platos", emoji: "🍳", tipo: "Desayunos tradicionales", precio: "$$", porQue: "Ambiente casero para un desayuno completo.", idealPara: "Desayuno", x: 44, y: 35 },
      { nombre: "Café Don Rogelio", emoji: "☕", tipo: "Café", precio: "$", porQue: "Opción clásica y accesible para un café rápido.", idealPara: "Desayuno / café", x: 45, y: 37 },
      { nombre: "Coco Café", emoji: "☕", tipo: "Café de especialidad", precio: "$$", porQue: "Buen lugar para trabajar o platicar con calma.", idealPara: "Desayuno / café", x: 42, y: 38 },
      { nombre: "PalReal", emoji: "☕", tipo: "Café de especialidad", precio: "$$", porQue: "Muy popular entre locales en Colonia Americana.", idealPara: "Desayuno / café", x: 43, y: 39 },
      { nombre: "Karmele", emoji: "🥐", tipo: "Panadería y café", precio: "$$", porQue: "Buena repostería europea con café de calidad.", idealPara: "Desayuno / merienda", x: 46, y: 36 },
      { nombre: "Cristina", emoji: "☕", tipo: "Café de especialidad", precio: "$$", porQue: "Ambiente agradable, buena opción de paso por la mañana.", idealPara: "Desayuno / café", x: 44, y: 34 },
    ],
  },
  {
    categoria: "Cocina contemporánea",
    color: "anil",
    icon: Star,
    lugares: [
      { nombre: "Alba Cocina Diversa", emoji: "🍽️", tipo: "Cocina de autor", precio: "$$$", porQue: "Propuesta contemporánea con producto local, muy bien valorada.", idealPara: "Cena especial", x: 44, y: 34 },
      { nombre: "Goiti", emoji: "🍽️", tipo: "Cocina de autor", precio: "$$$", porQue: "Una de las propuestas gastronómicas más finas de la ciudad.", idealPara: "Cena especial", x: 43, y: 35 },
      { nombre: "Pangea", emoji: "🍽️", tipo: "Cocina de autor", precio: "$$$", porQue: "Referente de alta cocina tapatía desde hace años.", idealPara: "Cena especial", x: 45, y: 33 },
    ],
  },
  {
    ...
    icon: PartyPopper,
    lugares: [
      { nombre: "Casa Bariachi", emoji: "🎉", direccion: "Av. Ignacio L. Vallarta 2221, Arcos Vallarta, Guadalajara", tipo: "Mariachi en vivo + cocina mexicana", precio: "$$", porQue: "Ambiente festivo con mariachi en vivo, ideal para grupos grandes.", idealPara: "Cena en grupo", x: 42, y: 37 },
      { nombre: "Cenaduría tradicional (ej. La Estancia)", emoji: "🌃", tipo: "Antojitos nocturnos", precio: "$", porQue: "Vivir la tradición tapatía de la 'cenaduría': pozole, enchiladas, sopes por la noche.", idealPara: "Cena informal", x: 58, y: 46 },
    ],
  },
];
...
const INFO_UTIL = [
  { icon: Plane, color: "anil", titulo: "Aeropuerto Internacional de Guadalajara (GDL)", texto: "Ubicado al sur de la ciudad, a 20-30 min de Punto Sur y 35-45 min de Minerva/Providencia según tráfico. Recomendamos Uber o taxi autorizado de la terminal." },
  ...
  { icon: CloudSun, color: "dorado", titulo: "Clima", texto: "Guadalajara tiene clima templado todo el año. En temporada de lluvias (junio-octubre) hay chubascos por las tardes; en temporada seca los días son soleados y las noches frescas. Lleven ropa en capas." },
  { icon: ShieldCheck, color: "verde", titulo: "Seguridad", texto: "Las zonas turísticas y de hospedaje recomendadas son seguras siguiendo precauciones normales de ciudad grande: usen Uber/taxi autorizado de noche, eviten mostrar objetos de valor y estén atentos en zonas concurridas." },
  { icon: Navigation, color: "rosa", titulo: "Tiempos de trayecto", texto: "Guadalajara es una ciudad extensa. Como referencia, casi todo dentro de la ciudad toma entre 10 y 45 minutos; las excursiones de un día (Tequila, Chapala) toman de 1 a 1.5 horas por trayecto." },
];
...
function CardPhoto({ emoji, color }) {
  return (
    <div className={`loteria-photo loteria-photo-placeholder cat-${color}`}>
...
function PlaceCard({ p, color, icon: Icon }) {
  return (
    <div className={`loteria-card cat-${color}`}>
      ...
      <CardPhoto emoji={p.emoji} color={color} />
      <div className="loteria-medallion"><Icon size={20} strokeWidth={2.25} /></div>
      <div className="loteria-frame">
        ...
        <div className="loteria-tiempos">
          ...
          <span>Desde Minerva/Prov./Amer.: <b>{p.min}</b></span>
        </div>
        <p className="loteria-tip">{p.tip}</p>
        <a className="loteria-maps" href={mapsLink(p.nombre)} target="_blank" rel="noopener noreferrer">
...
function RestaurantCard({ r, color, icon: Icon }) {
  return (
    <div className={`loteria-card compact cat-${color}`}>
      ...
      <div className="loteria-scallop" aria-hidden="true" />
      <CardPhoto emoji={r.emoji} color={color} />
      <div className="loteria-medallion small"><Icon size={17} strokeWidth={2.25} /></div>
      <div className="loteria-frame">
  ...
  return (
    <div className="inicio">
      <div className="hero">
        ...
        <p className="hero-sub">Lugares recomendados por María José y Joaquín Roberto</p>
      </div>
...
function HospedajeSection() {
  return (
    <div>
        ...
        {ZONAS_HOSPEDAJE.map((z) => (
          <div key={z.nombre} className="zona-card">
            ...
            <div className="zona-hotel">
              ...
              <span>Hotel sugerido: <b>{z.hotelSugerido}</b></span>
            </div>
      ...
      <div className="aviso-card aviso-trafico">
        <TrafficCone size={16} strokeWidth={2.25} />
        <p>{HOSPEDAJE_TRAFICO}</p>
      </div>
    </div>
  );
}
        ...
        {EVENTOS_BODA.map((e) => {
          ...
          return (
            <div key={e.nombre} className={`loteria-card cat-${e.color}`}>
              ...
              <div className="loteria-scallop" aria-hidden="true" />
              <CardPhoto emoji={e.emoji} color={e.color} />
              <div className="loteria-medallion"><Icon size={20} strokeWidth={2.25} /></div>
              <div className="loteria-frame">
    ...
    <div>
      ...
      <div className="map-wrap">
        <svg className="map-bg" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
          ...
          <text x="44" y="27" className="map-zone-label">MINERVA / PROVIDENCIA / AMERICANA</text>
    ...
    <div className="app-root">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .loteria-photo { position: relative; height: 108px; overflow: hidden; background: var(--crema); display: flex; align-items: center; justify-content: center; }
        .loteria-photo img { width: 100%; height: 100%; object-fit: cover; filter: saturate(0.85) contrast(1.02); }
        .loteria-photo-tint { position: absolute; inset: 0; mix-blend-mode: multiply; opacity: 0.16; }
        .loteria-photo-placeholder { background-image: repeating-linear-gradient(135deg, currentColor 0, currentColor 1.5px, transparent 1.5px, transparent 14px); opacity: 0.9; }
        .loteria-photo-placeholder svg { opacity: 0.4; }
        .loteria-photo-placeholder .emoji-big { font-size: 44px; line-height: 1; filter: drop-shadow(0 2px 3px rgba(42,26,20,0.18)); }
        .loteria-medallion { position: absolute; top: 96px; left: 16px; width: 38px; height: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: var(--crema-card); border: 2px solid currentColor; box-shadow: 0 2px 6px rgba(42,26,20,0.15); z-index: 2; }
        .loteria-medallion.small { width: 32px; height: 32px; top: 96px; }
        .cat-rosa .loteria-top-banner, .cat-rosa .loteria-medallion, .cat-rosa.loteria-photo-placeholder { color: var(--rosa); }
        .cat-terracota .loteria-top-banner, .cat-terracota .loteria-medallion, .cat-terracota.loteria-photo-placeholder { color: var(--terracota); }
        .cat-anil .loteria-top-banner, .cat-anil .loteria-medallion, .cat-anil.loteria-photo-placeholder { color: var(--anil); }
        .cat-dorado .loteria-top-banner, .cat-dorado .loteria-medallion, .cat-dorado.loteria-photo-placeholder { color: var(--dorado); }
        .cat-verde .loteria-top-banner, .cat-verde .loteria-medallion, .cat-verde.loteria-photo-placeholder { color: var(--verde); }
        ...
        .loteria-frame { padding: 16px 16px 14px; padding-top: 22px; flex: 1; display: flex; flex-direction: column; gap: 8px; }
