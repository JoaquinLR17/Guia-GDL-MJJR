...
const QUE_HACER = [
  ...
  },
  {
    ...
    lugares: [
      {
        nombre: "Colonia Americana", emoji: "🏘️", favorito: true,
  ...
  },
  {
    ...
    lugares: [
      ...
      {
        nombre: "Punto Sur", emoji: "🏬",
        descripcion: "Desarrollo comercial y de oficinas al sur de la ciudad, con tiendas, restaurantes y cines — cerca de la zona de hospedaje del mismo nombre.",
        ...
        tip: "Ideal para una escapada rápida sin salir mucho de la zona de hospedaje.",
        x: 50, y: 76,
      },
    ],
  },
  {
    ...
    lugares: [
      {
        nombre: "Bosque Los Colomos", emoji: "🌲", favorito: true,
  ...
  },
  {
    ...
    lugares: [
      ...
      {
        nombre: "Acuario Michin", emoji: "🐠", favorito: true,
  ...
  },
  {
    ...
    lugares: [
      ...
      { nombre: "José Cuervo Express", emoji: "🚂", descripcion: "Tren turístico que viaja de Guadalajara a Tequila con shows, catas y mariachi a bordo.", porQue: "Una forma distinta y muy divertida de llegar a Tequila, ideal para ir en grupo sin manejar.", tiempo: "Día completo (tour de todo el día)", costo: "Desde ~$3,000-4,500 MXN por persona (paquete todo incluido)", psur: "20-25 min a la estación", min: "15-20 min a la estación", tip: "Reserven con anticipación, es una experiencia muy popular y se agota rápido.", edgeSide: "left", edgeY: 38 },
      { nombre: "Cantaritos El Güero (Amatitán)", emoji: "🍹", favorito: true, descripcion: "Parada clásica en el trayecto a Tequila, famosa por su cantarito tradicional.", porQue: "Una parada icónica que complementa perfecto la ruta del tequila.", tiempo: "45 min - 1 hora", costo: "~$100-150 MXN por cantarito", psur: "1h - 1h 15min", min: "50 min - 1h 10min", tip: "Va de camino a Tequila, inclúyanlo en el mismo día.", edgeSide: "left", edgeY: 45 },
      ...
      { nombre: "Ajijic", emoji: "🎨", favorito: true, descripcion: "Pueblo con encanto a orillas de Chapala, calles empedradas y galerías de arte.", porQue: "Uno de los pueblos con más carácter cerca de Guadalajara.", tiempo: "3-4 horas", costo: "Gratis caminar", psur: "50 min - 1h", min: "1h - 1h 15min", tip: "Combínenlo con Chapala, están a 10-15 minutos uno del otro.", edgeSide: "bottom", edgeY: 80 },
    ],
  },
  {
    categoria: "Escapadas",
    ...
    lugares: [
      ...
      { nombre: "Puerto Vallarta", emoji: "🏖️", favorito: true, descripcion: "Ciudad de playa en la costa del Pacífico, con malecón, zona romántica y mar abierto.", porQue: "El cambio de paisaje más grande: playa y mar en vez de montaña o pueblo.", tiempo: "2-3 días (fin de semana largo)", costo: "Variable según hospedaje/actividades", psur: "4.5-5 h por carretera (o ~45 min en vuelo)", min: "4.5-5 h por carretera (o ~45 min en vuelo)", tip: "Es un viaje más largo que las demás escapadas — mejor planearlo como su propia mini-vacación, no como día extra improvisado.", edgeSide: "right", edgeY: 55 },
    ],
  },
];
...
const GASTRONOMIA = [
  {
    ...
    icon: ChefHat,
    lugares: [
      { nombre: "Karne Garibaldi", emoji: "🍲", favorito: true, sucursal: "Sucursal Santa Tere", direccion: "Calle Garibaldi 1306, Santa Teresita, Guadalajara", tipo: "Carne en su jugo", precio: "$$", porQue: "Guinness World Record al servicio más rápido; un clásico absoluto de Guadalajara.", idealPara: "Comida", nota: "Cadena con varias sucursales — esta es la original, cerca del Centro Histórico. También hay sucursal en Plaza Galerías, junto a Andares/Zapopan.", x: 58, y: 43 },
      { nombre: "El Chololo", emoji: "🐐", favorito: true, tipo: "Cocina tapatía / birria", precio: "$$", porQue: "Institución de varias generaciones, ambiente familiar tradicional.", idealPara: "Comida", x: 35, y: 33 },
      { nombre: "Las 9 Esquinas", emoji: "🍽️", favorito: true, tipo: "Cocina tapatía", precio: "$$", porQue: "Ubicado en un barrio con mucho carácter histórico, buena relación calidad-ambiente.", idealPara: "Comida o cena", x: 60, y: 48 },
      { nombre: "La Chata", emoji: "🍜", favorito: true, tipo: "Cocina tapatía", precio: "$$", porQue: "Décadas de tradición sirviendo platillos típicos jaliscienses.", idealPara: "Comida", x: 56, y: 44 },
      ...
      { nombre: "Casa Luna", emoji: "🌙", favorito: true, tipo: "Cocina mexicana contemporánea", precio: "$$$", porQue: "Buena opción para una comida más elegante sin salir de lo tradicional.", idealPara: "Comida o cena", x: 42, y: 36 },
    ],
  },
  {
    ...
    icon: Sandwich,
    lugares: [
      { nombre: "Tortas Toño", emoji: "🥪", favorito: true, sucursal: "Sucursal Providencia", direccion: "Tierra de Fuego 3160, Col. Providencia, Guadalajara", tipo: "Tortas ahogadas", precio: "$", porQue: "Nació en Providencia en 1990 y es la marca líder de torta ahogada en la ciudad.", idealPara: "Antojo o comida rápida", nota: "Cadena con varias sucursales — esta es la más cercana a la zona de Minerva/Providencia.", x: 47, y: 32 },
  ...
  },
  {
    ...
    icon: Soup,
    lugares: [
      { nombre: "Tacos Juan", emoji: "🌮", favorito: true, tipo: "Tacos", precio: "$", porQue: "Favorito local de barrio.", idealPara: "Antojo", x: 45, y: 40 },
      ...
      { nombre: "Los Alteños", emoji: "🌮", favorito: true, tipo: "Tacos al pastor / carnitas", precio: "$", porQue: "Clásico tapatío de trompo.", idealPara: "Antojo", x: 50, y: 42 },
  ...
  },
  {
    ...
    icon: Fish,
    lugares: [
      { nombre: "El Dorado (Santa Anita)", emoji: "🦐", favorito: true, tipo: "Mariscos", precio: "$$", porQue: "Punto de referencia para mariscos frescos en la zona metropolitana.", idealPara: "Comida", x: 78, y: 68 },
      ...
      { nombre: "Campomar", emoji: "🦞", favorito: true, tipo: "Mariscos", precio: "$$", porQue: "Muy recomendado por locales para mariscos frescos y bien preparados.", idealPara: "Comida", x: 40, y: 42 },
      { nombre: "Ponte Trucha Negro", emoji: "🍤", tipo: "Mariscos / tacos de mariscos", precio: "$$", porQue: "Otra opción popular de mariscos con buen sazón.", idealPara: "Comida / antojo", x: 41, y: 44 },
    ],
  },
  {
    ...
    lugares: [
      ...
      { nombre: "Café Don Rogelio", emoji: "☕", favorito: true, tipo: "Café", precio: "$", porQue: "Opción clásica y accesible para un café rápido.", idealPara: "Desayuno / café", x: 45, y: 37 },
      ...
      { nombre: "PalReal", emoji: "☕", favorito: true, tipo: "Café de especialidad", precio: "$$", porQue: "Muy popular entre locales en Colonia Americana.", idealPara: "Desayuno / café", x: 43, y: 39 },
      ...
      { nombre: "Alba Cocina Diversa", emoji: "🍽️", favorito: true, tipo: "Cocina de autor", precio: "$$$", porQue: "Propuesta contemporánea con producto local, muy bien valorada.", idealPara: "Cena especial", x: 44, y: 34 },
    ],
  },
  {
    ...
    icon: PartyPopper,
    lugares: [
      { nombre: "Casa Bariachi", emoji: "🎉", favorito: true, direccion: "Av. Ignacio L. Vallarta 2221, Arcos Vallarta, Guadalajara", tipo: "Mariachi en vivo + cocina mexicana", precio: "$$", porQue: "Ambiente festivo con mariachi en vivo, ideal para grupos grandes.", idealPara: "Cena en grupo", x: 42, y: 37 },
